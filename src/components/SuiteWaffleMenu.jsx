...
export default function SuiteWaffleMenu({ currentApp = 'hrms' }) {
  ...
  return (
    <div className="relative inline-block" ref={menuRef}>
      <button
        ...
        className={`min-w-[40px] min-h-[40px] flex items-center justify-center p-2 rounded-xl transition-all cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 ${
          isOpen 
            ? 'bg-cyan-50 dark:bg-slate-800 text-cyan-600 dark:text-white' 
            ...
            {APPS.map(app => {
              ...
              return (
                ...
                >
                  ...
                  {isCurrent ? (
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-cyan-50 dark:bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border border-cyan-200 dark:border-cyan-500/20 font-medium shrink-0 flex items-center gap-1">
